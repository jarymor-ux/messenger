...
import ru.ostap.userservice.util.RegistrationMessageSerializer;
...
public class KafkaConfiguration {
    ...
    public ProducerFactory<String, RegistrationMessage> producerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, RegistrationMessageSerializer.class);
